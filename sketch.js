...
// VIEWPORT - simpeler en beter voor p5.js
...
function showScoreFeedback() {
    ...
    if (correctCount === 0) {
        ...
        feedbackTitle = '😕 Begin goed! ' + correctCount + '/10';
        feedbackText = 'Je hebt er al een paar goed, maar er kunnen er nog veel meer! Blijf oefenen en controleer je antwoorden goed. Je kunt het!';
        feedbackColor = '#e67e22';
    } else if (correctCount <= 5) {
        feedbackTitle = '🙂 Halfway! ' + correctCount + '/10';
        feedbackText = 'Je bent al halverwege! Goed bezig, maar je moet nog even door. Controleer de verkeerde antwoorden en probeer opnieuw!';
        feedbackColor = '#f39c12';
    } else if (correctCount <= 7) {
        feedbackTitle = '😊 Goed bezig! ' + correctCount + '/10';
        feedbackText = 'Wow, meer dan de helft goed! Je bent er bijna. Nog een paar sommen te gaan en dan mag je de Dragon game spelen!';
        feedbackColor = '#3498db';
    } else if (correctCount <= 9) {
        feedbackTitle = '🤩 Bijna perfect! ' + correctCount + '/10';
        feedbackText = 'Fantastisch! Je hebt er bijna allemaal goed. Nog even opletten bij de laatste paar en dan roep je de draak op!';
