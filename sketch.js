...
class Obstacle {
  ...
  draw(gameY) {
    ...
    if (this.isPlatform) {
      ...
      stroke(139, 69, 19);
      strokeWeight(2);
      let platformY = gameY + (CELL_SIZE + 25);  //aangepast door vergrote CELL_SIZE//
  ...
  hits(dino, gameY) {
    if (this.isPlatform) {
      let platformTop = gameY + CELL_SIZE + 25; //hoger is lager platform//
      let platformBottom = gameY + CELL_SIZE + 25 + this.height; //hoger is lager platform//
...
function showInfo() {
    ...
    popup.innerHTML = `
        ...
        <p style="color: #0E0E0E; line-height: 1.2;">
            ...
            <strong>Dragon Game:<br></strong> Spring met spatie of muisklik.<br> Spring op de hoge gele trampolines en kom er met een grote boog uit door een snelle dubbelklik!<br>
