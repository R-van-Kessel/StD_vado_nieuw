...
const TITLE_SPACE = -100;      // ← hoogte grid
...
function showScoreFeedback() {
    ...
    if (correctCount === 0) {
        ...
        feedbackText = 'Je hebt er al één, twee of drie goed, maar ik weet dat jij beter kunt! Zet je berekeningen eerst op papier en controleer je antwoord goed. Je kunt het!';
